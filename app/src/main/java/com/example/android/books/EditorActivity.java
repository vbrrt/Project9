...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    /**
     * EditText field to enter the book's gender
     * private Spinner mGenderSpinner;
     */

    /**
     * Gender of the book. The possible values are:
     ...
     * implying that they are modifying the view, and
     * we change the mBookHasChanged boolean to true.
     *
     * ?? What does the following java code mean, creating an object or function???
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // in order to figure out if we're creating a new book or
        // editing and existing one
        // use getIntent() and getData() to get the associated URI
        // ?? where is getIntent is defined ???
        Intent intent = getIntent();
        mCurrentBookUri = intent.getData();

        // Set title of EditorActivity on which situation we have
        // If the EditorActivity was opened using the ListView item,
        // then we will have uri of book so change.
        // Otherwise if this is a new book, uri is null so change app bar
        // to say "Add a Book" if the intent DOES NOT contian a book content URI,
        // then we know that we are creating s new book.
        if (mCurrentBookUri == null) {
            // This is a new book, so chagne the app bar to say "Add a Book"
    ...
    private void saveBook() {
        ...
        // If the price is not provided by user, dont' try to parse the string into
        ...
        // If the quantity is not provided by user, dont' try to parse the string into
        // an integer value. Use 0 by default.
        //int quantity = 0;
        ...
        if (mCurrentBookUri == null) {
            // This is a NEW book, so inset a new book into the provider,
            ...
            // Otherwise, this is an EXISTING book, so update the book with content URI: mCurrentURi
